...
parts_to_add = {'N0': ['A', 'node', 'N0', '@ground>ND0:A:@ground'],
                'PCH1': ['A', 'pam-chassis', 'PCH1', '@rack>N0:A:l@oc0'],
                'PAM01': ['A', 'pam', 'PAM1', '@slot>PCH1:A:@slot01'],
                'PAM02': ['A', 'pam', 'PAM2', '@slot>PCH1:A:@slot02'],
                'PAM03': ['A', 'pam', 'PAM3', '@slot>PCH1:A:@slot03'],
                'PAM04': ['A', 'pam', 'PAM4', '@slot>PCH1:A:@slot04'],
                'PAM05': ['A', 'pam', 'PAM5', '@slot>PCH1:A:@slot05'],
                'PAM06': ['A', 'pam', 'PAM6', '@slot>PCH1:A:@slot06'],
                'PAM07': ['A', 'pam', 'PAM7', '@slot>PCH1:A:@slot07'],
                'PAM08': ['A', 'pam', 'PAM8', '@slot>PCH1:A:@slot08'],
                'PAM09': ['A', 'pam', 'PAM9', '@slot>PCH1:A:@slot09'],
                'PAM10': ['A', 'pam', 'PAM10', '@slot>PCH1:A:@slot10'],
                'PAM11': ['A', 'pam', 'PAM11', '@slot>PCH1:A:@slot11'],
                'PAM12': ['A', 'pam', 'PAM12', '@slot>PCH1:A:@slot12'],
