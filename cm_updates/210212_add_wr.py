...
mfgs = ['S10.486', 'S10.495', 'S10.490', 'S9.393', 'S10.475',
        'S10.474', 'S10.483', 'S10.487', 'S10.488']
ncms = [23, 24, 25, 26, 27, 28, 29, 30, 31]
macs = ['6e:b8:f5', '6e:a7:8b', '6e:cd:a4', 'b2:55:30', '6e:6c:bc',
        '6e:6e:f0', '6e:7d:ca', '6e:b8:fa', '6e:b9:75']
